...
class NickNameService {
    ...
    private val nouns = listOf(
        "여행자", "탐험가", "사진가", "음식가", "학자", "예술가", "운동가", "요리사", "뮤지션", "작가", "학생", "교사", "연구원", "디자이너", "엔지니어", "농부", "치과의사", "요가강사", "바리스타", "화가", "소설가", "건축가", "치어리더", "번역가", "연예인", "심리학자", "경찰관", "요리연구가", "간호사", "변호사", "회계사", "애니메이터", "프로그래머", "게임개발자", "운전사", "판사", "화학자", "물리학자", "천문학자", "지질학자", "도서관", "비행사", "심판", "마술사", "조종사", "광고인", "해커", "명상가", "등산가", "무용가", "연주자", "승무원", "사냥꾼", "요정", "도적", "캠퍼", "독서가", "컬렉터", "꽃집주인", "잠수부", "기자", "아티스트", "외계인", "히어로", "탐정", "농장주", "귀족", "프린스", "프린세스", "왕자", "왕녀", "용사", "마법사", "성기사", "궁수", "힐러", "초능력자", "요술사", "가수", "댄서", "개그맨", "코미디언", "공주", "공작", "시인", "백작", "마녀", "주술사", "무사", "검사", "술사", "대장", "영웅", "백성", "피아니스트", "드러머", "기타리스트", "베이시스트", "셰프", "파티셰", "소방관", "의사", "간호조무사", "군인", "모험가", "항공사", "건축사", "상인", "음악가", "사찰관", "철학자"
    )
